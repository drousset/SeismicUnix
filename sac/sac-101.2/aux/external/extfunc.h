...
typedef struct {
  ...
  long  ext_nhdr[MNHDR];     /* integer (long) header fields            */
  long  ext_ihdr[MIHDR];     /* enumerated header fields                */
  long  ext_lhdr[MLHDR];     /* logical header fields                   */
...
/* long header fields */  /* Note: ninf, nhst, and nsn were changed to norid, nevid, and nwfid
...
#define IACC    8  /* Acceleration (CM/SEC/SEC)   */
...
#define NUNDEF (-12345)     /* undefined value for integer (long) fields */
...
void fgetahdr_();
/* void fgetahdr_(long *hdr_index, char *fieldname, char *value,
                  long *error, long lenfield, long lenvalue)             */
...
void fsetahdr_();
/* void fsetahdr_(long *hdr_index, char *fieldname, char *value,
                  long *error, long lenfield, long lenvalue)             */
...
void fgetehdr_();
/* void fgetehdr_(long *hdr_index, char *fieldname, long *value, 
                  long *error, long lenfield)                            */

/* FORTRAN calling sequence:
   call fgetehdr(integer*4 hdr_index, character fieldname, integer*4 value, integer*4 error) */

void fsetehdr_();
/* void fsetehdr_(long *hdr_index, char *fieldname, long *value,
                  long *error, long lenfield)                            */
...
void fgetfhdr_();
/* void fgetfhdr_(long *hdr_index, char *fieldname, float *value,
                  long *error, long lenfield)                            */
...
void fsetfhdr_();
/* void fsetfhdr_(long *hdr_index, char *fieldname, float *value,
                  long *error, long lenfield)                             */
...
void fgetlhdr_();
/* void fgetlhdr_(long *hdr_index, char *fieldname, long *value,
                  long *error, long lenfield)                              */
...
void fsetlhdr_();
/* void fsetlhdr_(long *hdr_index, char *fieldname, long *value,
                  long *error, long lenfield)                              */
...
void fgetnhdr_();
/* void fgetnhdr_(long *hdr_index, char *fieldname, long *value,
                  long *error, long lenfield)                               */
...
void fsetnhdr_();
/* void fsetnhdr_(long *hdr_index, char *fieldname, long *value,
                  long *error, long lenfield)                                */
