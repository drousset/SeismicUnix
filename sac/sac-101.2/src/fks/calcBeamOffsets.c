...
void /*FUNCTION*/ calcBeamOffsets(ns, elevc, xr, yr, zr, nerr)
long ns, elevc;
float *xr, *yr, *zr;
long int *nerr;
{
        long ndx1, ndx2, idummy;
...
void cascade ( ns , elevc , xr , yr , zr , nerr ) 
int ns ;
float *xr , *yr , *zr ;
long int *nerr ;
{
...
int isInfoThere ( nFiles, elevc , nerr )
int nFiles ;
long elevc ;
long int *nerr ;
{
...
void refOffsets ( nFiles , referencePosition , xr , yr , zr , nerr )
int	nFiles ;
...
void userOffsets ( nFiles , xr , yr , zr , nerr ) 
int     nFiles ;
float   *xr , *yr , *zr;
long int *nerr ;
{
...
void eventOffsets ( nFiles , xr , yr , zr , nerr )
int	nFiles ;
float	*xr , *yr , *zr;
long int *nerr ;
{
