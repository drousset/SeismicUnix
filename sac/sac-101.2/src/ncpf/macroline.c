...
#include "mach.h"
#include "cpf.h"
long /*FUNCTION*/ macroline(kmacroline, kmacroline_s, ncmacroline, nerr)
char *kmacroline;   int kmacroline_s;
long int *ncmacroline, *nerr;
{
	char kiline[MCMSG+1], ktemp1[MCPFN+1], ktemp2[MCPFN+1],
	     ktoken[9] = "        ", runfile[MCPFN+1];
	long lrunmode, macroline_v;
	long int ic, ic1, ic2, idx, itype, nc, niline, nrfun, ntemp1, 
