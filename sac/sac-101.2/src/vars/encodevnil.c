...
long int node, offset, *nerr;
{
...
#endif
	/* - Encode descriptor. */
        Isacmem = (long*)cmmem.sacmem[Varsindex[node]]+offset;
  ...
  malloc_verify();
	...
	zputc( kmvars.valuename,MAXCVNAME+1, (long int *)Sacmem, (long int )(4*cmvars.namelength) );
