...
#include "../../inc/vars.h"
#include "../../inc/nvars.h"
void /*FUNCTION*/ getvlist(vars, vars_s, name, name_s, mode, nerr)
...
L_1000:
		if( nextvlist( &Indexsave[cmgetvlist.nlevelsgt], nextlistname,MAXCVNAME+1 ) ){
		  getvlist2((kmgetvlist.sublistnames[cmgetvlist.nlevelsgt - 1]),
				  MAXCENAME+1,
				  nextlistname,
				  MAXCVNAME+1, 
				  "ALL", 
