...
long int node, newlength, *nerr;
{
	long existsvlist;
	long int icchild1, icchild2, ichild2, icparent2, ioffset, newindex, 
	 ...
	 *             Fixed problem of new descriptor being two words long.
	...
	*nerr = 0;
	...
	decodevdesc( (long int *)cmmem.sacmem[oldindex], &cmvars.deleteflag, &cmvars.readonlyflag, 
	...
	copy( (long*)cmmem.sacmem[oldindex], (long*)cmmem.sacmem[newindex] + ioffset, 
	 oldlength );
	...
	encodevdesc( (long int *)cmmem.sacmem[newindex], &cmvars.deleteflag, &cmvars.readonlyflag, 
	 &cmvars.indirectflag, &cmvars.sharedflag, &cmvars.reservedflag, 
	 &cmvars.applflag1, &cmvars.applflag2, &cmvars.valuetype, &cmvars.desclength, 
	 &cmvars.namelength, &cmvars.valuelength );
