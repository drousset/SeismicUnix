...
long int *nerr;
{
	...
	long lopen;
	long int index, itemp[2], jvars, ncerr, nlocdisk, 
	 numwords, nun;
	void /*zputc(),*/ zwabs();
	...
	*nerr = 0;
	...
	Itemp[2] = VARSVERSION;
	zwabs( (int *)&nun, (char *)itemp, numwords, (int *)&nlocdisk, (int *)nerr );
	if( *nerr != 0 )
		goto L_8888;
	...
	zwabs( (int *)&nun, (char *)(cmmem.sacmem[index]), numwords, (int *)&nlocdisk, (int *)nerr );
	if( *nerr != 0 )
		goto L_8888;
