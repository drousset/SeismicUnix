...
long int *nerr;
{
	...
	long indirectsave;
	long int index, ncfullvars, ncname, nilindex, niloffset, node, 
...
/*			numcopy = Varsnilindex[cmvars.varsnode] - varindex - numdelete; */
			...
			copy( (long*)cmmem.sacmem[Varsindex[cmvars.varsnode]]+varindex+numdelete,
                              (long*)cmmem.sacmem[Varsindex[cmvars.varsnode]]+varindex, numcopy );
