...
long DoTime( short *year, short *day, short *hour, short *min, short *sec,
 ...
 *
 * lat positive to north long positive to east
 */
...
void rdsegy ( long int idfl , char *kfile , long int *nlen ,
	      long int *ndx1 , long int *ndx2 , long int *nerr )
{
    /* declare variables. */
    unsigned char *cptr ;
    short short_hold ;
    int num_sam , sam_rate , int_hold , idx ;
    long llon, llat , IBflag = TRUE , check ;
