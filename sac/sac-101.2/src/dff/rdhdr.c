...
long /*FUNCTION*/ rdhdr(idfl, nun, nerr)
long int idfl, *nun, *nerr;
{
	long int ic1, ic2, ncerr, ndaerr, nlcdsk, nlcmem, numrd;
	...
	*nerr = 0;
	...
	zrabs((int *) nun, (char *)buffer, numrd, (int *)&nlcdsk, (int *)nerr );
        ...
        hdrVer = (long *)( buffer + versionLocation ) ;
	...
	if( *nvhdr > 0 && *nvhdr < cmhdr.nvhdrc ){
		...
		*nerr = 0;
	    ...
	    zwabs((int *) nun, (char *)buffer, MHDRFILE, (int *)&nlcdsk, (int *)nerr );
