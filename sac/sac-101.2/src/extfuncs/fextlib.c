...
/* #define NULL 0 */
long setup_data(call_data, fyinput, fxinput, numfiles, nptsmax)
sac_files **call_data;
float **fyinput;
float **fxinput;
long *numfiles;
...
long setup_args(argc, argv, fargs, lenarg)
int argc;
char **argv;
char **fargs;
long *lenarg;
...
long retrieve_data(call_data, fyinput, fxinput, numfiles, nptsmax)
sac_files **call_data;
float *fyinput;
float *fxinput;
long numfiles;
