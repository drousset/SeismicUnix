   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_ARRIV_ARID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(arPntr, dbl_ARRIV_ARID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ARRIV_AUTH:{
        ...
        case dbl_ARRIV_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(arPntr, dbl_ARRIV_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ARRIV_CHANID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(arPntr, dbl_ARRIV_CHANID) );
           strcat(tmpstr,buffer);
           break;
        }
        ...
        case dbl_ARRIV_JDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(arPntr, dbl_ARRIV_JDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        ...
        case dbl_ARRIV_STASSID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(arPntr, dbl_ARRIV_STASSID) );
           strcat(tmpstr,buffer);
           break;
        }
				   ...
				   int nCols, char *tmpstr)
{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        case dbl_ASSOC_ARID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(asPntr, dbl_ASSOC_ARID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ASSOC_AZDEF:{
        ...
        case dbl_ASSOC_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(asPntr, dbl_ASSOC_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ASSOC_DELTA:{
        ...
        case dbl_ASSOC_ORID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(asPntr, dbl_ASSOC_ORID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ASSOC_PHASE:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_EVENT_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(evPntr, dbl_EVENT_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_EVENT_EVID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(evPntr, dbl_EVENT_EVID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_EVENT_EVNAME:{
        ...
        case dbl_EVENT_PREFOR:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(evPntr, dbl_EVENT_PREFOR) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_EVENT_LDDATE:{
				   ...
				   int nCols, char *tmpstr)
{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        case dbl_GR_GRN:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(grPntr, dbl_GR_GRN) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_GR_GRNAME:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_INS_INID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(inPntr, dbl_INS_INID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_INS_INSNAME:{
				   ...
				   int nCols, char *tmpstr)
{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        case dbl_ORIGE_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(oePntr, dbl_ORIGE_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGE_CONF:{
        ...
        case dbl_ORIGE_ORID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(oePntr, dbl_ORIGE_ORID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGE_SDEPTH:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_ORIGI_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_DEPDP:{
        ...
        case dbl_ORIGI_EVID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_EVID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_GRN:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_GRN) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_JDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_JDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_LAT:{
        ...
        case dbl_ORIGI_MBID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_MBID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_ML:{
        ...
        case dbl_ORIGI_MLID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_MLID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_MS:{
        ...
        case dbl_ORIGI_MSID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_MSID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_NASS:{
        ...
        case dbl_ORIGI_NDEF:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_NDEF) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_NDP:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_NDP) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_ORID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_ORID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_SRN:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(orPntr, dbl_ORIGI_SRN) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_ORIGI_TIME:{
				   ...
				   int nCols, char *tmpstr)
{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        case dbl_REMA_COMMID:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(rePntr, dbl_REMA_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_REMA_LINENO:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(rePntr, dbl_REMA_LINENO) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_REMA_REMARK:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_SENS_CHANID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(sePntr, dbl_SENS_CHANID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SENS_ENDTIME:{
        ...
        case dbl_SENS_INID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(sePntr, dbl_SENS_INID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SENS_INSTANT:{
        ...
        case dbl_SENS_JDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(sePntr, dbl_SENS_JDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SENS_STA:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_SITE_OFFDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(slPntr, dbl_SITE_OFFDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITE_ONDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(slPntr, dbl_SITE_ONDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITE_REFSTA:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(slPntr, dbl_SITE_REFSTA) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITE_STA:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_SITEC_CHANID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(scPntr, dbl_SITEC_CHANID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITEC_CTYPE:{
        ...
        case dbl_SITEC_OFFDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(scPntr, dbl_SITEC_OFFDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITEC_ONDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(scPntr, dbl_SITEC_ONDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SITEC_STA:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_STASS_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(saPntr, dbl_STASS_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_STASS_DEPTH:{
        ...
        case dbl_STASS_IMS:{
           sprintf(buffer,"%16s", *(double *) dblGetTableObject(saPntr, dbl_STASS_IMS) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_STASS_LAT:{
        ...
        case dbl_STASS_STASSID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(saPntr, dbl_STASS_STASSID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_STASS_TIME:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_WFDIS_CHANID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_CHANID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_CLIP:{
        ...
        case dbl_WFDIS_COMMID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_COMMID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_DATATYPE:{
	   ...
	   sprintf(buffer,"%24s", tmListEpochTime( *(double *)
        ...
        case dbl_WFDIS_FOFF:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_FOFF) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_INSTYPE:{
        ...
        case dbl_WFDIS_JDATE:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_JDATE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_NSAMP:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_NSAMP) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_SAMPRATE:{
	   ...
	   sprintf(buffer,"%24s", tmListEpochTime( *(double *)
        ...
        case dbl_WFDIS_WFID:{
           sprintf(buffer,"%12d", *(long *) dblGetTableObject(wfPntr, dbl_WFDIS_WFID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFDIS_LDDATE:{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        ...
        case dbl_WFTAG_TAGID:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(wtPntr, dbl_WFTAG_TAGID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFTAG_WFID:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(wtPntr, dbl_WFTAG_WFID) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_WFTAG_LDDATE:{
				   ...
				   int nCols, char *tmpstr)
{
   ...
   *tmpstr = 0;
   for(j=0;j<nCols;j++){
     switch (attribute[j]){
        case dbl_SACD_SYNTHFLG:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_SYNTHFLG) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SACD_LPSPOL:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_LPSPOL) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SACD_IZTYPE:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_IZTYPE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SACD_IDEP:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_IDEP) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SACD_IFTYPE:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_IFTYPE) );
           strcat(tmpstr,buffer);
           break;
        }
        case dbl_SACD_WFID:{
           sprintf(buffer,"%8d", *(long *) dblGetTableObject(sdPntr, dbl_SACD_WFID) );
           strcat(tmpstr,buffer);
           break;
        }
     }
