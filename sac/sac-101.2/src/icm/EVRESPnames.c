...
********************* Access Functions *****************************   
   ...
   long int getHour(enum Direction);
   long int getMinute(enum Direction);
   long int getSecond(enum Direction);
...
#ifdef __STDC__
long int getHour(enum Direction dir)
#else
long int getHour(dir)
enum Direction dir ;
#endif
...
#ifdef __STDC__
long int getMinute(enum Direction dir)
#else
long int getMinute(dir)
enum Direction dir;
#endif
...
#ifdef __STDC__
long int getSecond(enum Direction dir)
#else
long int getSecond(dir)
enum Direction dir ;
#endif
