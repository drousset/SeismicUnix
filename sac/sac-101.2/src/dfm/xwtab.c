...
void /*FUNCTION*/ xwtab( long int *nerr )
{
	...
	long int nstr, nchg, nchange, nwrdir, nlen, ndx1, ndx2, nderr ;
        long lexpnd, liftype, lheader, lwrdir ;
        long int idx, ic1, ic2, jdfl, nchar, ndform,
                 nstring;
        FILE *nun;
