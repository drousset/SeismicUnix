...
long int *nerr;
{
	long int ilhdr[MLHDR], jdx, jj, jjj, ncards, nderr, ndx1, 
	 ndx2, nlcmem, nlen, nremdr;
        FILE *nun;

        float *Sacmem;

	long *const Ilhdr = &ilhdr[0] - 1;
