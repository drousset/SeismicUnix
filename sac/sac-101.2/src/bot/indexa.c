...
#include "../../inc/proto.h"
long /*FUNCTION*/ indexa(string, string_s, kchar, lfwd, locc)
char *string;   int string_s;
long int kchar;
long lfwd, locc;
{
	long int _d_l, _d_m, _do0, _do1, ic, ic1, ic2, ic3, ic_, indexa_v, 
	 nc, do_count;

	/*=====================================================================
	 * PURPOSE: Searches for the occurance of a single character within
