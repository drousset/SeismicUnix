...
char *errmsg;
{
	long int bufptr, datptr, k, lsamp, memory, ncmp, nextra, vrtptr;
	double e;
...
L_1:
	 ...
	 * */
	copy( (long*)&Inbuf[nextra + 1], (long*)&Inbuf[1], memory );
	 ...
	 * */
	copy( (long*)&Data[datptr], (long*)&Inbuf[memory + 1], ncmp );
...
L_4:
	 ...
	 * */
	copy( (long*)&Outbuf[memory + 1], (long*)&Result[datptr], ncmp );
