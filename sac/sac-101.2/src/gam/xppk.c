...
long int *nerr;
{
	...
	byte kchar;
	long int iwf[5], jdx, jdfl, jdfl1, jdfl2,
...
/*	static char kzref[9] = "Z       ";
	static long lfirst = TRUE;
*/	static long lint = FALSE;
/*	static long lt = FALSE;
...
L_4000:
	...
	/* -- Characterize first arrival. */
	    ...
	    ndxpk = 1 + (long)( (secinc - *b)/ *delta + 0.9 );
