...
long /*FUNCTION*/ nextcontseg(number, level, start, stop)
long int *number, *level, *start, *stop;
{
	long nextcontseg_v;
        long *Isacmem1, *Isacmem2, *Isacmem3;
	...
	if( *number <= 0 ){
		...
		*number = *number + 1;
        ...
        Isacmem1 = (long *)cmmem.sacmem[cmcontouring.indexstarts];
        Isacmem2 = (long *)cmmem.sacmem[cmcontouring.indexlevels];
        Isacmem3 = (long *)cmmem.sacmem[cmcontouring.indexstops];
