...
void /*FUNCTION*/ calccontsegs(array, nxsize, nysize, nerr)
float array[];
long int nxsize, nysize, *nerr;
{
	long highright[4], storemode;
	long int ihigh, ilow, inum, jlevel, jlevel_, jx, jx_, jxstart, 
	 jxstop, jy, jy_, jystart, jystop;
	...
	long *const Highright = &highright[0] - 1;
