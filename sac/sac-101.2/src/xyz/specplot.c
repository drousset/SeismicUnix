...
long int *nerr;
{
	...
	long l1dttm, lany, lbotaxsave, lbottcsave, lframesave, ltitlsave, 
	 ltoptcsave, lwait, lxgrdsave, lxlabsave, lxlims, lylabsave;
	long int n1dttm[6], nlcx, nlcy, num;
        long nystart, nypoints;
	...
	void zgetgd(), zgpmsg();
	static long lrel = FALSE;
	static long lperpl = FALSE;
	static long nperpl = 3;
