...
long int m;
{
	long int _d_l, _d_m, _do0, _do1, i, i0, i0_, i_, id, is, j, k, 
	 k_, n, n2, n4;
	float t1;
...
long int m;
{
	long int _d_l, _d_m, _do0, _do1, i, i1, i1_, i_, id, is, j, k, 
	 k_, n, n2, n4;
	float t1;
...
float x1[], x2[], x3[], x4[];
{
	long int _d_l, _d_m, _do0, _do1, _do2, _do3, _do4, _do5, i1, i1_, 
