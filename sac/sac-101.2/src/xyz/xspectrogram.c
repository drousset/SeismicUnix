...
long int *nerr;
{
	long int idx, idum, indexdata, indexheader, itemp1, itemp2, itemp3, 
...
/*      static long lprew  = FALSE;
        ...
        static long lsqrt  = FALSE;
        static long llog   = FALSE;
        static long llog10 = FALSE;
