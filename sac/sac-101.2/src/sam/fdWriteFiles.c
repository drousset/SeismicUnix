...
void /* FUNCTION */ fdWriteFiles ( long int * memptr , char * kprefix ,
				   ...
				   long int * nerr )
{
	...
	long int fileDescriptor = 0 , hdrindex , xbegin = 0 ,
