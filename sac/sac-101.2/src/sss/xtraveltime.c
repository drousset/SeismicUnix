...
long int *nerr;
{
	...
	long lbcksp, lexpnd, lfree, lmore, lphase, lpicks = FALSE, ltoend;
	long int idx, ic, ic1, ic2, index, iopch[MXTT], iphase, 
	...
	long lmodel = FALSE ,	/* was global, now it's local.  maf 960829 */
...
void readtaup ( FILE *taupfile , long int *ncurves , long int *nerr )
{
