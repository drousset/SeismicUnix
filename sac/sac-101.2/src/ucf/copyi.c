...
long int isrce[], isink[], ncopy;
{
	long int j, j_, lsink, lsrce;
	void zmemad();

	long *const Isink = &isink[0] - 1;
	long *const Isrce = &isrce[0] - 1;
	...
	zmemad( (short *)&Isrce[1], &lsrce );
	zmemad( (short *)&Isink[1], &lsink );
