...
long int *nerr;
{
	...
	float begin1, delta1, delta2, diff, divsor, value;

        float *Sacmem1, *Sacmem2;

	/*=====================================================================
	 * PURPOSE:  To execute the action command DIVF.
	 *           This command divides a set of files into data in memory.
	 *=====================================================================
	 * OUTPUT ARGUMENTS:
