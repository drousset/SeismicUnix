...
enum    opID{help=0,dbname,connect,srclat,srclon,srcdep,srcbox,srcdist,
	     ...
	     authlist,eventid,srccircle,quadrant,phaselist,showsql,cmdfile,wfid};
...
int MaxParamNum[NUMOPTIONS] = {2,1,1,2,2,2,-1,2,-1,2,2,2,2,6,
			       6,-1,1,-1,2,2,-1,2,0,-1,-1,3,2,-1,1,1,-1};
