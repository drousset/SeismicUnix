...
struct t_cmcsf {
	long int nlev, nlvusd[MLEV], nlvlen[MLEV], ntop, nmvtop, ncur, 
	 nbot, nmvbot;
	long lcsemp;
	long int ncs, narg, narg1, narg2, ntokdl, nmsgdl, neoc, nstype[MTOK], 
	 ntok;
	float extcsf[20];
	}	cmcsf;
struct t_kmcsf {
...
long *const Nlvlen = &cmcsf.nlvlen[0] - 1;
long *const Nlvusd = &cmcsf.nlvusd[0] - 1;
long *const Nstype = &cmcsf.nstype[0] - 1;
#else
extern float *const Extcsf;
extern long *const Nlvlen;
extern long *const Nlvusd;
extern long *const Nstype;
#endif
