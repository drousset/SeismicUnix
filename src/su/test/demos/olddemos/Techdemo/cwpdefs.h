 ...
 * $Revision: 2.8 $ ; $Date: 88/11/20 00:01:32 $
 */
...
extern float *vector(), **matrix();
extern int *ivector(), **imatrix();
extern double *dvector(), **dmatrix();
extern void free_vector(), free_ivector(), free_dvector();
extern void free_matrix(), free_imatrix(), free_dmatrix();
