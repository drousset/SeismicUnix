	...
	strcpy(bhdr[25].key,"polyt");
	strcpy(bhdr[25].type,"int");
	bhdr[25].offs = (char*)&bh.polyt - (char*)&bh;

	strcpy(bhdr[26].key,"vpol");
	strcpy(bhdr[26].type,"int");
	bhdr[26].offs = (char*)&bh.vpol - (char*)&bh;

	strcpy(bhdr[27].key,"name");
	strcpy(bhdr[27].type,"char");
	bhdr[27].offs = (char*)bh.name - (char*)&bh;

	strcpy(bhdr[28].key,"area");
	strcpy(bhdr[28].type,"char");
	bhdr[28].offs = (char*)bh.area - (char*)&bh;

	strcpy(bhdr[29].key,"client");
	strcpy(bhdr[29].type,"char");
	bhdr[29].offs = (char*)bh.client - (char*)&bh;

	strcpy(bhdr[30].key,"esize");
	strcpy(bhdr[30].type,"int");
	bhdr[30].offs = (char*)&bh.esize - (char*)&bh;
