/* SUPROD: $Revision: 2.7 $ ; $Date: 89/05/25 16:53:13 $	*/
...
string sdoc = "\
								\n\
SUPROD - get the product of two data sets			\n\
								\n\
suprod data1 data2 >stdout					\n\
								\n\
...
static string progid =
	"   $Source: /src/su/src/RCS/suprod.c,v $";
static string revid =
	"   $Revision: 2.7 $ ; $Date: 89/05/25 16:53:13 $";
...
int argc; char **argv;
{
	...
	while (fgettr(fd1, &intrace1) &&
		...
		vmul_(intrace2.data, ONE, intrace1.data, ONE,
