/* SUQUO: $Revision: 2.8 $ ; $Date: 89/05/27 16:49:10 $		*/
...
string sdoc = "\
								\n\
SUQUO - get the quotient of two data sets			\n\
								\n\
suquo data1 data2 >stdout					\n\
								\n\
Note1:	Output = data1 / data2 with the header of data1		\n\
								\n\
...
static string progid =
	"   $Source: /src/su/src/RCS/suquo.c,v $";
static string revid =
	"   $Revision: 2.8 $ ; $Date: 89/05/27 16:49:10 $";
...
int argc; char **argv;
{
	...
	while (fgettr(fd1, &intrace1) &&
		...
		vdiv_(intrace1.data, ONE, intrace2.data, ONE,
