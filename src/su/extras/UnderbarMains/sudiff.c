/* SUDIFF: $Revision: 2.7 $ ; $Date: 89/05/27 16:48:33 $	*/
...
string sdoc = "\
								\n\
SUDIFF - get the difference between two data sets		\n\
								\n\
...
static string progid =
	"   $Source: /src/su/src/RCS/sudiff.c,v $";
static string revid =
	"   $Revision: 2.7 $ ; $Date: 89/05/27 16:48:33 $";
...
int argc; char **argv;
{
	...
	while (fgettr(fd1, &intrace1) &&
		...
		vsub_(intrace1.data, ONE, intrace2.data, ONE,
