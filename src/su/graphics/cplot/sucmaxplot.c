/* SUCMAXPLOT: $Revision: 1.7 $ ; $Date: 90/10/19 10:33:27 $		*/
...
string sdoc = "\
									\n\
SUCMAXPLOT - Graph of trace-by-trace maximum amplitude for a 		\n\
	    panel of SU data traces (with optional running average)	\n\
									\n\
sucmaxplot <data [optional parameters] | pen_program			\n\
									\n\
Optional Parameters:							\n\
