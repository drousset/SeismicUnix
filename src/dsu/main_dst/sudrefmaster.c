...
"                  outputs the modeled time seismograms in a file.       ",
"                                                                        ",
"                  The code SUDREFSVSLAVE implements the slave functions ",
"                  and should be installed with SUDREFSVMASTER. One      ",
"                  Makefile is provided for the installation of both     ",
"                  codes. See installation instructions below.           ",
"                                                                        ",
"                  The communication and synchronization routines are    ",
"                  provided by the PVM library. The version used by      ",
"                  SUDREFSVMAIN is the version 3.3.9 or higher. The user ",
"                  should install PVM prior to the installation of this  ",
"                  code.                                                 ",
"                                                                        ",
...
"                                                                        ",
" SUDREFSVMASTER output the synthetic data in SEGY format to standard    ",
" output. First the vertical then the horizontal component.              ",
"                                                                        ",
" Notes on installation:                                                 ",
"                                                                        ",
" Along with the source codes for SUDREFSVMASTER and SUDREFSVSLAVE and   ",
" respective header files it should be available the file Makefile.aimk. ",
" After installation of PVM the command aimk will make the executable    ",
" files and install them in the proper directories for execution.        ",
"                                                                        ",
...
" Notes on execution:                                                    ",
"                                                                        ",
" You should start PVM before the execution of SUDREFSVMASTER. By typing ",
" sudrefsvmaster a man page for the code is provided. Each slave will    ",
" generate a report file names PSU[XXX], where [XXX] is the process id   ",
" number.                                                                ",
"                                                                        ",
...
"                                                                        ",
" 2) The receivers must be on line with source                           ",
"                                                                        ",
" 3) Point source (explosion like) is not implemented                    ",
"                                                                        ",
