...
typedef struct {	/* wgc - trace identification header */
	...
	int idnti4;	/* ident number (byte 5-8) */
	...
	int xcdsi4;	/* x-coordinate at source location (byte 17-20) */

	int ycdsi4;	/* y-coordinate at source location (byte 21-24) */

	short stcsi2;	/* static correction at source location (byte 25-26) */

	short eledi2;	/* elevation at detector location (byte 27-28) */

	int xcddi4;	/* x-coordinate at detector location (byte 29-32) */
			/* or post-stack x-coordinate at centroid location */
	
	int ycddi4;	/* y-coordinate at detector location (byte 33-36) */
	...
	int frlni4;	/* field reel number or field shot identifier */
			/* (byte 81-84) */
	...
	int snsli4;	/* station number at source location (byte 197-200) */

	int sndli4;	/* station number at detector location (byte 201-204) */

	int snmli4;	/* station number at midpoint location (byte 205-208) */

	int cdnsi4;	/* cdf number at source location (byte 209-212) */

	int cdndi4;	/* cdf number at detector location (byte 213-216) */

	int cdnmi4;	/* cdf number at midpoint location (byte 217-220) */
	...
	int ttypi4;	/* data trace type identification (byte 301-304)  */
	...
	int itodi4;	/* time of day (byte 365-368) */
	...
	int fdrni4;	/* field reel number (byte 385-388) */
