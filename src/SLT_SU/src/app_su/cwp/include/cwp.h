...
#if !defined(iv_defs_h) && !defined(iv_boolean_h) /* for InterViews */
      typedef unsigned int boolean ;
      static const boolean false = 0;
      static const boolean true = 1;
#endif
#else /* if not C++, define the bool as before */
...
#define file64(x)       fseeko(x,0,1);
#define file2g(x)       fseeko(x,0,1);
#define fseek2g(x,y,z)  fseeko(x,y,z);
#define ftell2g(x)  ftello(x);
#define fseek64(x,y,z)  fseeko(x,y,z);
#define ftell64(x)  ftello(x);
