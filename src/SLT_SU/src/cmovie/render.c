...
Render   RenderInit(void)
{
    ...
    {    extern int _alloc;
        ...
        render = (Render) calloc((1) , sizeof(render[0]));
...
void RenderSize(int wide, int hite)
{
    ...
    if (wide != render->wide || hite != render->hite ){
        ...
        {   extern int _alloc;
            ...
            render->image =
                (Buffer) calloc((render->wide * render->hite) ,
        ...
        };
        {
            ...
            render->zbuffer =
                (Zbuffer) calloc((render->wide * render->hite) ,
        ...
        {   extern int _alloc;
            ...
            render->shadow =
                (Shadow) calloc((render->wide * render->hite) ,
           ...
           int v0, Render render, int *margins, RenderAttr attr)
{
    ...
    {   extern int _alloc;
        ...
        vmap1.map = (Vec) calloc((MapSize(&vmap1)) , sizeof(vmap1.map[0]));
