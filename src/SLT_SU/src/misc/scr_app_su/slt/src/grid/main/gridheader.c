...
"               1=time(depth)-trace-line				\n" 
"               2=time(depth)-line-trace				\n" 
"               3=trace-time(depth)-line				\n" 
"               4=trace-line-time(depth)				\n" 
"               5=line-time(depth)-trace				\n" 
"               6=line-trace-time(depth)				\n" 
"gtype=         grid type   						\n"
"               0=not defined;						\n"
"               1=time-rms velocity					\n" 
...
"               4=time-depth 		 				\n" 
"skip=0         skip number of bytes in the input \n"
"\n"
"NOTE: \n"
...
main(int argc, char **argv)
{
	...
	int iout=0, i, i1, ierr=0;
	char *trace, *traceout;

	ghed gh;
	int skip;
	long long iseek, jseek;
	off_t lofset;
	int nread;
	...
	*/
	jseek=-GHDRBYTES;
	bcopy(&jseek,&lofset,8);
	fseek2g(infp,lofset,2);
	nread = fread( &gh,1,GHDRBYTES,infp);
	if(nread!=GHDRBYTES) err(" grid header error \n");
