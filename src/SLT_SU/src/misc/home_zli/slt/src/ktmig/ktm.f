...
c$doacross local(ixy,yi,xi,dys,dyg,dxs,dxg,dy2s,dy2g,dx2s,dx2g) 
c$& local(d2s,d2g,xp,yp,tmp,t,it0,iiend,ii,it,ots,otg,ts,tg)
c$& local(dov2,iang,iiend,scs,scg,fxmax,iwx,fymax,iwy,iw,indxw,work2)
c$& local(itmp,itmp2,sc1,sc2,t,coss,cosg,a)
c$& shared(x,y,xm,ym,aperxx,aperyy,cosa,sina,oaa,obb,cc)
c$& shared(tau0,odtau,s02,oincd,otan2,ntm,fovt2,epsx,epsy,f0o,s2,nf)
c$& shared(incdxw,imuter,ntres,work1,nxy,sy,sx,gx,gy,nf,s2,kxmaxo)
c$& shared(w1, kymaxo,shift,resamp)
c$& shared(fold,mig)
