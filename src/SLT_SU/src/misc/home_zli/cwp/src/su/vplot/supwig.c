/* SUPWIG: $Revision: 1.5 $ ; $Date: 90/11/10 13:21:14 $                */
...
/*      vp_erase (); */
	...
	for(i3=0;i3<n3;i3++)
	{
		...
		vp_scale (1.,1.);
		vp_color (PURPLE);    /* color for title */
		strcpy(titletemp,title);
		vp_text (2.5,1.3,titlsz,0,titletemp);
	}
	return;
}
