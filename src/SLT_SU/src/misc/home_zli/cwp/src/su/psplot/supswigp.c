/* SUPSWIGP: $Revision: 1.8 $ ; $Date: 91/03/05 15:18:04 $		*/
...
string sdoc =
" 									\n"
" SUPSWIGP - PostScript WIGgle-trace polygon plot of a segy data set 	\n"
" 									\n"
" supswigp <stdin >postscript file [optional parameters]		\n"
" 							        	\n"
" Optional parameters: 							\n"
" 							        	\n"
...
main(int argc, char **argv)
{
	...
	/* System call to pswigp */
	sprintf(plotcmd, "pswigp n1=%d n2=%d d1=%f d2=%f f1=%f f2=%f",
			   nt, ntr, d1, d2, f1, f2);
