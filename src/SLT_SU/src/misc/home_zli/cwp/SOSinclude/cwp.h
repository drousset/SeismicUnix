...
#ifdef __convex__
        #define file64(x)       fseek64(x,0,1);
        #define file2g(x)       fseek64(x,0,1);
        #define fseek2g(x,y,z)  fseek64(x,y,z);
        #define ftell2g(x)  ftell64(x);
#else
        #define file64(x)       fseek(x,0,1);
        #define file2g(x)       fseek(x,0,1);
        #define fseek2g(x,y,z)  fseek(x,y,z);
        #define ftell2g(x)  ftell(x);
        #define fseek64(x,y,z)  fseek(x,y,z);
        #define ftell64(x)  ftell(x);
#endif
