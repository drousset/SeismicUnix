...
"               saltbot2 \n"
"ivatbn=1       compute velocity value at the nearest grid point of the salt boundary \n"
"               0=assign the salt velocity to the nearest grid point \n"
"               1=compute the velocity of the nearest grid point \n"
"                 to minimize the travel time error at the deeper part \n"
"               2=use distance-weighted slowness to compute the \n"
"                 velocity at the nearest grid point \n"
" Notes:						\n"
...
main(int argc, char **argv)
{
	...
	int ivatbn;
	float dzz,dzz1,dzz2,v11,v22, vvt, vvb, vvt2, vvb2;
	int ivvt, ivvb, ivvt2, ivvb2;
	...
	if(!getparstring("ivatbn",&ivatbn) ) ivatbn = 1;
