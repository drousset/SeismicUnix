...
"                   =0 the depth of the horizon is given at the first \n"
"                   grid point where the grid value equals gridvalue \n"
"nullvalue=0        output value where no grid value equals gridvalue \n"
"tol=0.             tolerance \n"
"zmax=              maximum depth to search for the gridvalue \n"
"                   default to the maximum depth of input grid \n"
"\n"
"NOTES:						 			\n"
"\n"
...
main(int argc, char **argv)
{
	...
	if (!getparfloat("zmax",&zmax)) zmax = o1+(n1-1)*d1;
