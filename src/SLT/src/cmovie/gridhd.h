...
typedef struct {                /* grid header */
    ...
    float    scale;             /* scale to be applied to all the variables
                                   below */
    ...
    float    n1;                /* number of samples of the 1st axis of the
                                   grid */

    float    n2;                /* number of samples of the 2nd axis of the
                                   grid */

    float    n3;                /* number of samples of the 3rd axis of the
                                   grid */

    float    n4;                /* number of samples of the 4th axis of the
                                   grid */

    float    n5;                /* number of samples of the 5th axis of the
                                   grid */

    float    d1;                /* coordinate increment of the 1st axis of
                                   the grid */

    float    d2;                /* coordinate increment of the 2nd axis of
                                   the grid */

    float    d3;                /* coordinate increment of the 3rd axis of
                                   the grid */

    float    d4;                /* coordinate increment of the 4th axis of
                                   the grid */

    float    d5;                /* coordinate increment of the 5th axis of
                                   the grid */

    float    o1;                /* starting coordinate of the 1st axis of the 
                                   grid */

    float    o2;                /* starting coordinate of the 2nd axis of the 
                                   grid */

    float    o3;                /* starting coordinate of the 3rd axis of the 
                                   grid */

    float    o4;                /* starting coordinate of the 4th axis of the 
                                   grid */

    float    o5;                /* starting coordinate of the 5th axis of the 
                                   grid */
