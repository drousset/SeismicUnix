			...
			for(i4=0;i4<n4;i4++) {
				for(i3=0;i3<n3;i3=i3+m3) {
					...
					for(i1=0;i1<n1;i1++) {
						...
						iseek = n2*(i3+i1*n3+i4*n3*n1+ i5*n4*n3*n1);
						iseek = iseek*sizeof(float);

						fseek64(outfp,iseek,0);
