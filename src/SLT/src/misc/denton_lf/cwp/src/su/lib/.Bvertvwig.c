/* VERTWIG: $Revision: 1.2 $ ; $Date: 90/05/25 19:41:47 $	*/
...
/* vertwig - convert a trace to a vertical wiggle plot
 *
 * Returns:
 *	void
 *
 * Synopsis:
 *	void vertwig(data, n, fill)
 *	float *data;
 *	int n, fill;
 *
 * Credits:
