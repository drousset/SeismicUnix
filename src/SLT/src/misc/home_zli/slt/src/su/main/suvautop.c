...
"vint_ori                   Name of original 3D interval velocity grid  \n"
"Optional Parameters:\n"
"plow=90                    Lowest percentage of rms velocity to scan \n"
"phig=110                   Highest percentage of rms velocity to scan \n"
...
"3. It is recommended to run agc on input data before velocity picking.	\n"
