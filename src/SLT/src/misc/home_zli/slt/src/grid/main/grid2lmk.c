...
"l2=s1                 crossline coordinate of 2nd corner of 3D grid	\n"
...
"   (x2,y2) has the smallest s value and the largest l value            \n"
"              (s2 is usually =(ncdppl-1)*ds, l2 is usually =0.0)      \n"
"   (x3,y3) has the largest s value and the smallest l value            \n"
