 ...
 *	
 * $Author: rbeards $
 * $Source: /app/seismic/NU_SU/app_su/cwp/include/RCS/segy.h,v $
 * $Revision: 1.1 $ ; $Date: 2004/11/10 19:54:16 $
 */ 
...
typedef struct {	/* segy - trace identification header */
	...
	short unass[11];	/* unassigned--NOTE: last entry causes 
